...
switch trialwas
        ...
        case {82 83 84}
            ...
            scolour= [0 .5 1]; %bright blue
        case {92 93 94}
            
            scolour= [1 0 0]; %bright organge
...
%         %circle the trial?
%         text(median(xvec)-1, -.2, '*', 'color' ,'k', 'fontsize', fontsize*5 )
%     end
% end
    tcount=tcount+1;
end
...
text(40, 1.55, '*', 'color',[0 0 1] , 'FontSize', fontsize*4);
text(50, 1.60, 'Low speed tone', 'color','k', 'FontSize', fontsize*2);


text(120, 1.55, '*', 'color', [1 0 0], 'FontSize', fontsize*4);
text(130, 1.60, 'High speed tone', 'color','k', 'FontSize', fontsize*2);

% 
% text(40, -1.5, '*', 'color' ,'k', 'Fontsize', fontsize*4)
% text(50, -1.5, 'Matched Example', 'color' ,'k', 'Fontsize', fontsize*2)
